...
public class Servidor {
	...
	public static void main(String[] args) {				
        ...
        System.out.println("(Introduce Inicio para comenzar):");
...
class EscuchadorConexiones implements Runnable{  
    ...
    public void run() {
    	while(!Servidor.terminaEscuchador){
	        try{
